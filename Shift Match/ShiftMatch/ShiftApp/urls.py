...
from .views import registration, userLogin, adminLogin, idRequest, calendarShiftInput, shiftMatching, calendarView, MatchView, PickupPoolView,dashboard, pickingUpShifts, ShiftStatusView, SettingsView
...
urlpatterns = [
    ...
    path('ShiftApp/pcikingUpShift', pickingUpShifts, name='pickingUpShifts'),
